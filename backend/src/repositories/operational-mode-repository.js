export class OperationalModeRepository {
  ...
  async set(modeKey, enabled, { actorId = null, reason = "" } = {}) {
    if (!["registrations_disabled", "auth_initiation_disabled", "player_mutations_disabled", "authored_events_disabled", "player_surfaces_disabled", "investigations_disabled"].includes(modeKey)) {
